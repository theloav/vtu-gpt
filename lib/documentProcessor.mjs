...
// import pdfParse from 'pdf-parse'; // Kept for now; will attempt commonjs later if issue persists
import * as pdfParse from 'pdf-parse'; // Changed to namespace import to address TypeError: (0, h.default) is not a function
// const pdfParse = require('pdf-parse'); // Attempting CommonJS require for pdf-parse
...
if (typeof globalThis.DOMMatrix === 'undefined') {
  globalThis.DOMMatrix = class DOMMatrix {
    ...
    // Add any methods or properties that are strictly required by pdfjs-dist
    // For text extraction, often just existence is enough.
    // If further methods are called, they might need mock implementations.
    scale() { return this; }
...
// Import canvas to ensure DOMMatrix polyfill is available (commented out as it did not resolve the issue directly)
// import 'canvas';
